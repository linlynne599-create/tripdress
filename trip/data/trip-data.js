  ...
  const days = [
    ...
    },
    {
      ...
      items: [
        ...
        { time: '08:00–09:30', title: '机场 → 凡尔赛门贝斯特韦斯特酒店', kind: 'transfer', note: '包车接机' },
        { time: '10:00–12:00', title: '卢浮宫', kind: 'sight', status: 'booked', note: '地铁 M12 线约 30 分钟', img: 'louvre' },
        { time: '12:00–13:00', title: '午餐', kind: 'food' },
        { time: '13:00–15:00', title: '香榭丽舍大道逛街', kind: 'shop', img: 'champs-elysees' },
        { time: '15:00–16:30', title: '凯旋门', kind: 'sight', img: 'arc-de-triomphe' },
        { time: '17:00–18:00', title: '塞纳河游船', kind: 'sight', note: '排队的话就 pass；淘宝买划算', img: 'seine' },
        { time: '19:00–20:00', title: '埃菲尔铁塔', kind: 'sight', img: 'eiffel' },
      ],
    },
    {
      n: 3,
    ...
    },
    {
      ...
      items: [
        ...
        { time: '12:00–13:30', title: '老佛爷百货 + 午餐', kind: 'shop', img: 'lafayette' },
        { time: '13:30–14:00', title: '前往蒙马特高地', kind: 'transfer' },
        { time: '14:00–17:00', title: '蒙马特：爱墙、圣心堂、小丘广场', kind: 'sight', img: 'montmartre' },
      ],
    },
    {
      n: 5,
